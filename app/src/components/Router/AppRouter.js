    ...
    return (
        <Router>
                <Routes>
                    ...
                    {/* Sitios */}
                    <Route path="/sitiosDisponibles"        element={ <ContentSitesAvalible/> }  /> {/* Ver Lista de Sitios Disponibles */}
                    <Route path="/sitiosOcupados"           element={ <ContentUnavalible/> } />     {/* Ver Lista de Sitios No Disponibles */}  
                    {/* Clientes */}
                    <Route path="/addClientes"              element={ <Persons/> } />       {/* Registrar Datos de Clientes */}
                    <Route path="/listClientes"             element={ <ListPersons/> }/>    {/* Ver Lista de Clientes */}
                    <Route path="/editClientes"             element={ <EditPerson/> }/>     {/* Modificar Datos de Clientes */}
                    <Route path="/statusClientes"           element={ <DeletePerson/> } />  {/* Eliminar Clientes */}
                    <Route path="/viewClientes"             element={ <ViewPerson/> } />    {/* Ver Datos de Clientes */}
                    {/* Empleados */}
                    <Route path="/addEmpleados"             element={ <Employee/> }/>       {/* Registrar Datos de Empleados */}
                    <Route path="/listEmpleados"            element={ <ListEmployee />}/>   {/* Ver Lista de Empleados */}
                    <Route path="/editEmpleados"            element={ <EditEmpleado/> }/>   {/* Modificar Datos de Empleados */}
                    <Route path="/statusEmpleados"          element={ <DeleteEmployee/> }/> {/* Eliminar Empleados */}
                    <Route path="/viewEmpleados"            element={ <ViewEmployee/> }/>   {/* Ver Datos de Empleados */}                  
                    {/* Vehiculo */}
