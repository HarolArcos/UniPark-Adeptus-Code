...
export const Vehicle = () => {
    ...
    const{data,loading} = useFetch('http://localhost/UniPark-Adeptus-Code/ADEPTUSCODE-BackEnd/app/apiVehicle/apiVehicle.php/listVehicle');
                    ...
                    <tbody>
                        {loading? (<tr>
                            ...
                            vehiculos.map((item) =>(
                                ...
                                <td>
                                    <button className='btn btn-success btn-md mr-1' onClick={() => handleEditar(item)}>
                                    ...
                                    <button className='btn btn-success btn-md mr-1'  onClick={() => handleEliminar(item.vehiculo_id)} >
